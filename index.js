...
// const fruitloops = createMenuItem('fruitloops', 2.50, 'Breakfast');
// const meatloaf = createMenuItem('meatloaf', 5, 'Dinner');
...
reviews[reviews.length -1]['feedback'] = 'this place is a chill place to hang';
// console.log(reviews)
